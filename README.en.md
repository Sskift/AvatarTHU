...
3. The conversation receives a review card. Each assignment keeps one cloud document and updates the same link for later revisions; all deliverables are embedded there and every independent review remains at the end. Documents have five sections: **assignment description, progress and key results, complete deliverables, review and actions, and independent review history**. They support numbered lists, formulas, tables, and result images. Native PDF and Office attachments preserve the original report layout for preview.
